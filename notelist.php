...
<table id="filterTable">
	<tr>
	<th><input type="text" id="filterNotes" onkeyup="filterTable()" placeholder="按笔记标题搜索.." style="background:transparent;border:none;"></th>
	</tr>
</table>
<table id="notelistTable">
    ...
    foreach ($files as &$value) {
        if ($counter > $counterMax) {
            echo "<tr><td>已达到要列出的最大笔记数 (". $counterMax . ")</td><td></td>";
